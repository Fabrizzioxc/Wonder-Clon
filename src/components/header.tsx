      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <div className="bg-slate-800 text-white px-4 py-2 rounded font-bold text-lg">WONDER.LEGAL</div>
          ...
          <div className="flex items-center">
            <div className="relative">
              <Input type="text" placeholder="Buscar" className="w-48 pr-10 border-gray-300" />
              <Button
                size="sm"
