    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-md mx-auto px-4 py-12">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-navy-900 mb-2">Mi Cuenta</h1>
          ...
          <TabsContent value="register">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Crea una nueva cuenta para acceder a todos nuestros servicios</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
